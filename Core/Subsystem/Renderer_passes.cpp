...
void Renderer::PassOpaque()
{
	...
	bShowWireframe ? command_list->SetRasterizerState(cull_none_solid):command_list->SetRasterizerState(cull_none_wireframe);
	command_list->SetBlendState(blend_enable);
